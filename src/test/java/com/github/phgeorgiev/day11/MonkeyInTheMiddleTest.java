...
public class MonkeyInTheMiddleTest extends BaseTestUtils {
  ...
  void shouldFindMonkeyBusiness() {
    ...
    assertEquals(10605, new MonkeyInTheMiddle(input).getMonkeyBusiness());
  }

  @Test
  void shouldFindMonkeyBusinessFromTest() throws IOException {
    assertEquals(67830, new MonkeyInTheMiddle(input()).getMonkeyBusiness());
  }
}
